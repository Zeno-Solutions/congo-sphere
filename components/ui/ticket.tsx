  ...
  return (
      ...
      <div className="bg-[url('/bg1.jpeg')] overflow-hidden bg-no-repeat  bg-cover border rounded-lg shadow-lg px-6 py-4 max-w-4xl mx-auto mt-8">
        ...
        <div className="relative flex justify-between z-8 max-h-50  p-0">
          <div className="flex ">
            <div className="bg-[#eee8f17c] skew-x-9 pl-3 min-w-105 z-10 rounded-2xl">
              <h1 className="font-black max-w-80 overflow-hidden max-h-18 z-15 text-black  flex-wrap text-3xl ">
                Martial OYAGA
              </h1>
