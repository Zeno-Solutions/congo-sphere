...
export default function Newsletter() {
    return (
        <section className="mt-24 mx-15 my-12 relative rounded-[3rem] overflow-hidden bg-slate-900 border border-white/5 shadow-2xl px-6">
            ...
            <div className="relative grid md:grid-cols-2 gap-12 p-12 md:p-20 items-center">
                <div>
                    <h2 className="text-4xl font-extrabold font-headline text-white mb-6 leading-tight">Stay in the Orbit.</h2>
                    ...
                    <p className="text-[10px] text-outline mt-4 uppercase tracking-widest font-bold">No spam. Only magic. Unsubscribe anytime.</p>
                </div>
