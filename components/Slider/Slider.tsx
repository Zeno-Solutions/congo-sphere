...
export default function Slider() {
    ...
    const handlePrev = () => {
        const nextIndex = currentIndex === 0 ? featuredEvents.length - 1 : currentIndex - 1
            ...
            <section className="mb-16 mx-auto max-w-500">
                <div className="flex  items-center justify-between  mb-8">
                    ...
                    <div className="hidden sm:flex gap-2">
                        ...
                        >
                            <span className="material-symbols-outlined"><ChevronLeft size={30} color='white' className=' rounded-full border-2 hover:bg-blue-600 transition ease-in shadow-2xl ' /></span>
                        </button>
                        <button
                            onClick={handleNext}
                        ...
                        >
                            <span className="material-symbols-outlined"><ChevronRight size={30} color='white' className=' cursor-pointer rounded-full border-2 hover:bg-blue-600 transition ease-in shadow-2xl' /></span>
                        </button>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 p-8 w-full">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-white/60 text-xs font-body">• {formatDate(event.date)}</span>
                                </div>
                                ...
                                <Link href={`/events/${event.id}`} className="flex items-center gap-2 text-white font-bold font-label text-sm group/btn hover:text-primary transition-colors">
                                    Book Tickets
