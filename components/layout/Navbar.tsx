        ...
        <div className=" w-full flex justify-evenly items-center px-6 py-4">
          ...
          {(Islogin && (
            ...
            <div className="flex items-center gap-4 px-10">
              <Link
                href="/login"
                className="text-slate-400 cursor-pointer font-bold font-label rounded-full text-sm px-4 py-2 hover:text-white transition-all active:scale-95"
              >
                Login
              </Link>
              <Link
                href="/register"
                className="text-white text-on-primary-fixed cursor-pointer font-bold font-label text-sm px-6 py-2.5 rounded-full shadow-[0_0_20px_rgba(204,151,255,0.4)] hover:shadow-[0_0_30px_rgba(204,151,255,0.6)] transition-all active:scale-95"
              >
                Register
              </Link>
            </div>
