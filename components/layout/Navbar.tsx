    ...
    return (
        <nav className='sticky top-0 left-0 z-100'>
            <Contenaire className='bg-slate-950/50   backdrop-blur-xl z-50 shadow-[0_20px_40px_rgba(138,43,226,0.15)]'>
                <div
                    className=" w-full flex justify-evenly items-center px-6 py-4">
                    ...
                    <div className="flex items-center gap-4 px-10">
                        <Link href="/login">
                            <button className="text-slate-400 cursor-pointer font-bold font-label text-sm px-4 py-2 hover:text-white transition-all active:scale-95">Login</button>
                        </Link>
                        <Link href="/register">
