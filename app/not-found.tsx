                ...
                <div className="w-full max-w-2xl text-center space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-on-surface-variant text-lg max-w-md mx-auto leading-relaxed">
                            ...
                            Don't worry, the sphere is vast and mysterious.
                        </p>
                    </div>
                    ...
                    <div className="pt-12">
                        <div className="flex justify-center space-x-4">
                            ...
                            <div className="w-2 h-2 bg-secondary/30 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                            <div className="w-2 h-2 bg-tertiary/30 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                        </div>
                    </div>
                </div>
            </main>
