...
export const metadata = {
  ...
  description:
    "Questions fréquemment posées sur Congo Sphere. Trouvez des réponses à vos questions.",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Connect to your account and use our event organization tool.
              </p>
            </div>
            <div className="bg-slate-900 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">
              ...
              <p className="text-gray-400">
                Some events are free, others are paid. Check the details of each
                event.
              </p>
            </div>
            <div className="bg-slate-900 p-6 rounded-lg">
